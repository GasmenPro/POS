...
$page_title = APP_NAME . ' — Add Supplier';
        ...
        <form method="post" action="<?php echo e(BASE_URL); ?>/suppliers/process.php">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="supplier_code" name="supplier_code" maxlength="50" value="<?php echo e($old['supplier_code'] ?? ''); ?>" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="supplier_name">Supplier Name</label>
                    <input type="text" class="form-control" id="supplier_name" name="supplier_name" value="<?php echo e($old['supplier_name'] ?? ''); ?>" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="contact_person">Contact Person</label>
                    <input type="text" class="form-control" id="contact_person" name="contact_person" value="<?php echo e($old['contact_person'] ?? ''); ?>">
                </div>
                <div class="col-md-6">
