...
<main class="col-md-9 col-lg-10 p-4">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6 col-xl-4"><div class="card h-100 report-card"><div class="card-body">
            <h2 class="h5"><i class="bi bi-receipt text-primary me-1" aria-hidden="true"></i> Sales Report</h2>
        ...
        <div class="col-md-6 col-xl-4"><div class="card h-100 report-card"><div class="card-body">
            <h2 class="h5"><i class="bi bi-boxes text-primary me-1" aria-hidden="true"></i> Inventory Report</h2>
        ...
        <div class="col-md-6 col-xl-4"><div class="card h-100 report-card"><div class="card-body">
            <h2 class="h5"><i class="bi bi-arrow-left-right text-primary me-1" aria-hidden="true"></i> Inventory Movements</h2>
        ...
        <div class="col-md-6 col-xl-4"><div class="card h-100 report-card"><div class="card-body">
            <h2 class="h5"><i class="bi bi-exclamation-triangle text-primary me-1" aria-hidden="true"></i> Stock Status</h2>
        ...
        <div class="col-md-6 col-xl-4"><div class="card h-100 report-card"><div class="card-body">
            <h2 class="h5"><i class="bi bi-truck text-primary me-1" aria-hidden="true"></i> Supplier Stock-In Activity</h2>
